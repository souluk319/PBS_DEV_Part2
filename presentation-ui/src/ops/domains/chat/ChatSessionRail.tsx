...
import { getHandoffBotLabel } from "../../../app/handoff";
            ...
            >
              <div className="flex items-start justify-between gap-3">
                <div className="min-w-0">
                  ...
                  {session.handoff ? (
                    <div className="mt-2 inline-flex items-center rounded-full border border-primary/30 bg-primary/10 px-2 py-0.5 text-[10px] font-semibold uppercase tracking-[0.16em] text-primary">
                      {getHandoffBotLabel(session.handoff.fromBot)} handoff
                    </div>
                  ) : null}
